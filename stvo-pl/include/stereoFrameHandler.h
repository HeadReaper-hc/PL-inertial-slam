...
public:
    ...
    void initialize( const Mat img_l_, const Mat img_r_, const int idx_, long double t);
    void insertStereoPair(const Mat img_l_, const Mat img_r_, const int idx_);
    void insertStereoPair(const Mat img_l_, const Mat img_r_, const int idx_, long double t);
    void updateFrame();
