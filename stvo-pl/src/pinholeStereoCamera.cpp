...
PinholeStereoCamera::PinholeStereoCamera(const string &params_file) {
    ...
    if( camera_model == "Pinhole" )
    {
        ...
        if(dset_config["T_BS"].IsDefined()){
            YAML::Node T_BS_node = dset_config["T_BS"];
            vector<double> T_BS_vec = T_BS_node["data"].as<vector<double>>();
            T_BS << T_BS_vec[0], T_BS_vec[1], T_BS_vec[2], T_BS_vec[3],
                    T_BS_vec[4], T_BS_vec[5], T_BS_vec[6], T_BS_vec[7],
                    T_BS_vec[8], T_BS_vec[9], T_BS_vec[10], T_BS_vec[11],
                    T_BS_vec[12], T_BS_vec[13], T_BS_vec[14], T_BS_vec[15];
        }
    }
    else
