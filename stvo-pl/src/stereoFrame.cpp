...
StereoFrame::StereoFrame(const Mat img_l_, const Mat img_r_, const int idx_, PinholeStereoCamera *cam_, double time_) :
    img_l(img_l_), img_r(img_r_), frame_idx(idx_), cam(cam_), t_(time_) {
